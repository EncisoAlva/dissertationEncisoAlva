...
Electroencephalography (EEG) consists of the collocation of surface electrodes, whose contact surface is in the order of 20 \si{mm^2}, on the subjects' exposed scalp.
%
...
It is reasonable to state that the electric scalar field measured by the EEG electrodes is caused to post-synaptic potentials at the .
%
...
As the transition from neuron dipoles to EEG sensors loses information, activity from low-entropy regions (i.e., neurons with synchronous firing and similar orientations) can be recovered under appropriate assumptions.
...
% an essential consideration in the practice is the location of the dipoles. 
%
