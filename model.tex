...
\begin{figure}
\centering
\includegraphics{./img_dev/Pregions.png}
\caption{Designation of P-regions based on observed pathology data: hypoxia due to acute ischemic stroke, observed using TTC staining}
\end{figure}
