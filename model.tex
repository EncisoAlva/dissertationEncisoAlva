...
Figures \ref{fig:results1_P}, \ref{fig:deets_P}, and \ref{fig:noise_degradation_P} are extensions of figures
\ref{fig:results1}, \ref{fig:deets}, and \ref{fig:noise_degradation} including data using the proposed solver.
%
