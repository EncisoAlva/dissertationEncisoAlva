...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{img_stats/P_scatter_EvalMetrics_Protocol04_30.pdf}
    \caption{Data for this graph is the same from figure \ref{fig:results1} for the proposed solver}
    \label{fig:deets_P}
\end{figure}
...
figures \ref{fig:results1_P}, \ref{fig:deets_P}, and \ref{fig:noise_degradation_P}; these figures are clearly extensions of figures
...
\begin{itemize}
    ...
    \item The proposed method is not very sensible to the shape of the source patch. 
