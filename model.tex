...
Thinking about equation \eqref{eq:3.25} in particular, we can exploit the property on equation \eqref{eq:3.27} to factor $\AAA_\Theta$ as
\begin{align}
...
\subsection{Functional P-regions}
