...
The location of the $p$-th source patch, $\mm_p$, is defined as a center of mass of the dipoles in the source patch,
\begin{equation}
    \mm_p = 
...
\begin{figure}
\centering
\includegraphics[width=\linewidth]{./img/AUROC_sketch.pdf}
%
\caption{
