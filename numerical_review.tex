...
\includegraphics[width=1.8in]{./img_MATLAB/square_Profile}
\includegraphics{./img_MATLAB/gauss_GroundTruth}
\includegraphics[width=1.8in]{./img_MATLAB/gauss_Profile}
\includegraphics{./img_MATLAB/exp_GroundTruth}
\includegraphics[width=1.8in]{./img_MATLAB/exp_Profile}
\includegraphics{./img_MATLAB/circ_GroundTruth}
\includegraphics[width=1.8in]{./img_MATLAB/circ_Profile}
