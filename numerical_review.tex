...
%
For instance, Figure [] shows the results for only the SYSSY solver.
%
...
%
Average Precision, which is more robust to class imbalance than the Area Under the Receiver-Operator Curve (AUROC), shows a large variability for sources at a depth of approx 20 mm; this is due to source patches placed at the brain sulci.

%Figure [] is similar to Figure [] for sLORETA. 

\begin{figure}
    \centering
    \includegraphics[width=0.45\linewidth]{img_stats/plot_EvalMetrics_Protocol04_30DLE.pdf}
    \includegraphics[width=0.45\linewidth]{img_stats/plot_EvalMetrics_Protocol04_30SpaDis.pdf}
    \includegraphics[width=0.45\linewidth]{img_stats/plot_EvalMetrics_Protocol04_30AUROC.pdf}
    \includegraphics[width=0.45\linewidth]{img_stats/plot_EvalMetrics_Protocol04_30AvgPre.pdf}
...
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{img_stats/plot_EvalMetrics_Protocol04_30DLE.pdf}
    \caption{Data for this graph is the same from Figure \ref{fig:results1} for the SISSY solver and SNR = 30 dB.}
    \label{fig:results2}
\end{figure}
