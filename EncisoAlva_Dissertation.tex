...
% for more bibtex templates
\usepackage[backend=biber,
style=ieee,
sorting=nyt]{biblatex}
\addbibresource{refs.bib}

% not sure what this does, but required by biblatex
\usepackage{csquotes}
...
\numberwithin{equation}{section}
    \input{psfig.sty}
       ...
       \committee{Jianzhong Su, PhD}{Hristo Kojouharov}{Ren-Cang Li}{Li Wang}{}{}
...
\thispagestyle{empty}
	...
	\vspace*{1.0in}
	\begin{center}
To my brother E. Ricardo, my mother Mar\'ia Guadalupe, and my late father Nicol\'as.

Despite the harsh times, we stay afloat and continue.
%
This is the way.
	\end{center}
